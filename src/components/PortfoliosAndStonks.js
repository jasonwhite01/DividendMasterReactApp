...
function PortfoliosAndStonks({login}){
    ...
    portfolios.forEach(portfolio => {      
        let htmlSegment = `<tr><td><i class="fa fa-briefcase w3-text-blue w3-large"></i></td><td><a href="http://google.com">${ portfolio.portfolioName }</a></td><td>${ portfolio.portfolioStonks }</td>`;
